...
template <class T> inline T *set_partial_array_mask(T obj) {
  assert(((uintptr_t)(void *)obj & G1_PARTIAL_ARRAY_MASK) == 0,
         "Information loss!");
...
public:
  G1ParScanPartialArrayClosure(G1CollectedHeap *g1,
                               G1ParScanThreadState *par_scan_state,
                               ReferenceProcessor *rp)
      : G1ParClosureSuper(g1, par_scan_state),
...
public:
  G1ParCopyHelper(G1CollectedHeap *g1, G1ParScanThreadState *par_scan_state)
      : _scanned_klass(NULL), G1ParClosureSuper(g1, par_scan_state) {}
...
public:
  G1ParCopyClosure(G1CollectedHeap *g1, G1ParScanThreadState *par_scan_state,
                   ReferenceProcessor *rp)
      : _scanner(g1, par_scan_state, rp), G1ParCopyHelper(g1, par_scan_state) {
    assert(_ref_processor == NULL, "sanity");
  }
...
public:
  FilterIntoCSClosure(DirtyCardToOopClosure *dcto_cl, G1CollectedHeap *g1,
                      OopClosure *oc)
...
public:
  G1UpdateRSOrPushRefOopClosure(G1CollectedHeap *g1h, G1RemSet *rs,
                                OopsInHeapRegionClosure *push_ref_cl,
                                bool record_refs_into_cset, int worker_i = 0);
