...
bash configure --with-boot-jdk=$JAVA7_HOME --with-target-bits=64 --with-debug-level=slowdebug --with-freetype-include=/usr/local/include/freetype2/freetype --with-freetype-lib=/usr/local/lib/
